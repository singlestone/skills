export default [{
    ...
    firstName: 'Melissa',
    lastName: 'Joseph',
    skills: ["Sales", "Account Management", "CRM", "Strategy", "Sales Management", "Salesforce.com", "SaaS", "Sales Process", "Sales Operations", "Business Strategy", "Marketing", "Cloud Computing", "Lead Generation", "Solution Selling", "Enterprise Software", "Marketing Strategy", "Team Building", "Strategic Partnerships", "Cold Calling", "Professional Services", "Management", "Customer Relationship Management (CRM)", "Contract Negotiation", "Selling", "Information Technology", "Managed Services", "Leadership", "Recruiting", "Real Estate", "Ethical Leadership", "SOLID Principles", "New Business Development", "IT Security Best Practices", "Consulting", "Customer Experience", "Digital Strategy", "Change Management"]
}, {
    username: 'jkabel',
    firstName: 'Jay',
    lastName: 'Kabel',
